    ...
    for y2_x2 in tqdm(y2s_x2):
        for y1_x5 in tqdm(y1s_x5):
            for y2_x5 in tqdm(y2s_x5):
                ...
                df.loc[df.index >= 20000, "target"] = (
                    2 * df.loc[df.index >= 20000].X_1
                    + y2_x2 * df.loc[df.index >= 20000].X_2 ** 2
                    + 3 * np.sin(2 * np.pi * df.loc[df.index >= 20000].X_3)
                    - 0.4 * df.loc[df.index >= 20000].X_4
                    + y2_x5 * df.loc[df.index >= 20000].X_5 ** 2
                    + (
                        2 * df.loc[df.index >= 20000].X_1.shift(1)
                        + y2_x2 * df.loc[df.index >= 20000].X_2.shift(1) ** 2
                        + 3 * np.sin(2 * np.pi * df.loc[df.index >= 20000].X_3.shift(1))
                        - 0.4 * df.loc[df.index >= 20000].X_4.shift(1)
                        + y2_x5 * df.loc[df.index >= 20000].X_5.shift(1) ** 2
                    )
                    + df.loc[df.index >= 20000].noise
                )
                ...
                while True:
                    try:
                        ...
                        continue
                    break
            with open("dict_results_example_1.pickle", "wb") as handle:
